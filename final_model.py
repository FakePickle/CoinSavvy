...
# high_predictor_model = RandomForestRegressor(n_estimators=100, random_state=42)
# high_predictor_model.fit(X_train1, y_train1) 
...
# low_predictor_model = RandomForestRegressor(n_estimators=100, random_state=42)
# low_predictor_model.fit(X_train_2, y_train_2)
...
# volume_predictor_model = RandomForestRegressor(n_estimators=100, random_state=42)
# volume_predictor_model.fit(X_train_3, y_train_3)
...
# close_predictor_model = RandomForestRegressor(n_estimators=100, random_state=42)
# close_predictor_model.fit(X_train_4, y_train_4)
